/*
TinySerial.cpp (formerly SoftwareSerial.cpp, formerly NewSoftSerial.cpp) - 
...
Ted 2017-08-02: Stripped everything not needed for this project to save memory
...
//uint8_t TinySerial::_receive_buffer[_SS_MAX_RX_BUFF]; 
...
// Constructor
//
TinySerial::TinySerial( uint8_t transmitPin) : 
...
uint16_t TinySerial::subtract_cap(uint16_t num, uint16_t sub) {
  if (num > sub)
    return num - sub;
  else
    return 1;
...
//void TinySerial::setRxIntMsk(bool enable)
//{
//    if (enable)
